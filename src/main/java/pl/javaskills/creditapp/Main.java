...
public class Main {
    public static void main(String[] args) {
        ...
        CreditApplicationService creditApplicationService = new CreditApplicationService(new PersonScoringCalculator());
        System.out.println(creditApplicationService.getDecision(loanAplication).getDecisionString());
